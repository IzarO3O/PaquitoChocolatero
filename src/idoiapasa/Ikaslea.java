...
public class Ikaslea implements Serializable{
	//warning "add generated serial version id"
	/**
	 * 
	 */
	...
	public String toXML(){
		return "<ikaslea>\n"+
				"<izena>" + this.izena + "</izena>\n"+
				"<abizenak>" + this.abizenak + "</abizena>\n"+
				"<nan>" + this.nan + "</nan>\n"+
				"<batazbestekonota>" + Double.toString(this.batazbestekoNota) + "</batazbestekonota>"
				+ "</ikaslea>\n";
	}
