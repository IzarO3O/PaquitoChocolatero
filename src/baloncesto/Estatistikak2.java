...
public class Estatistikak2 extends JFrame {
	...
	public Estatistikak2() {
		...
		JLabel lblJaylenPickett = new JLabel("Jalen Pickett");
		lblJaylenPickett.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblJaylenPickett.setBounds(175, 0, 106, 33);
		contentPane.add(lblJaylenPickett);
		
		JLabel lblnikolajokin = new JLabel("Nikola Jokic");
		lblnikolajokin.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblnikolajokin.setBounds(175, 36, 106, 40);
		contentPane.add(lblnikolajokin);
		
		JLabel lbljayHuff = new JLabel("Jay Huff");
		lbljayHuff.setHorizontalAlignment(SwingConstants.CENTER);
		lbljayHuff.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lbljayHuff.setBounds(136, 75, 167, 40);
		contentPane.add(lbljayHuff);
		
		JLabel lblzekennaji = new JLabel("Zeke Nnaji");
		lblzekennaji.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblzekennaji.setBounds(175, 118, 106, 40);
		contentPane.add(lblzekennaji);
		
		JLabel lblBraxtonKey = new JLabel("Braxton Key");
		lblBraxtonKey.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblBraxtonKey.setBounds(175, 156, 106, 33);
		contentPane.add(lblBraxtonKey);
		
		JLabel lblLucaDoncic = new JLabel("Luka Doncic");
		lblLucaDoncic.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblLucaDoncic.setBounds(175, 189, 106, 33);
		contentPane.add(lblLucaDoncic);
		
		JLabel lblyreIrving = new JLabel("Kyre irving");
		lblyreIrving.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblyreIrving.setBounds(175, 222, 106, 33);
		contentPane.add(lblyreIrving);
		
		JLabel lblGrantwilliams = new JLabel("Grant Williams");
		lblGrantwilliams.setHorizontalAlignment(SwingConstants.CENTER);
		lblGrantwilliams.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblGrantwilliams.setBounds(136, 255, 167, 33);
		contentPane.add(lblGrantwilliams);
		
		JLabel lblDerricJones = new JLabel("Derric Jones");
		lblDerricJones.setHorizontalAlignment(SwingConstants.CENTER);
		lblDerricJones.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblDerricJones.setBounds(136, 288, 167, 33);
		contentPane.add(lblDerricJones);
		
		JLabel lblDereckLively = new JLabel("Dereck Lively");
		lblDereckLively.setHorizontalAlignment(SwingConstants.CENTER);
		lblDereckLively.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblDereckLively.setBounds(136, 324, 173, 40);
		contentPane.add(lblDereckLively);
		
		JLabel lblstephenCurry = new JLabel("Stephen Curry");
		lblstephenCurry.setHorizontalAlignment(SwingConstants.CENTER);
		lblstephenCurry.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblstephenCurry.setBounds(136, 362, 167, 35);
		contentPane.add(lblstephenCurry);
		
		JLabel lblKlayThompson = new JLabel("Klay Thompson");
		lblKlayThompson.setHorizontalAlignment(SwingConstants.CENTER);
		lblKlayThompson.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblKlayThompson.setBounds(136, 397, 167, 33);
		contentPane.add(lblKlayThompson);
		
		JLabel lblDraymondGreen = new JLabel("Draymond Green");
		lblDraymondGreen.setHorizontalAlignment(SwingConstants.CENTER);
		lblDraymondGreen.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblDraymondGreen.setBounds(136, 428, 167, 35);
		contentPane.add(lblDraymondGreen);
		
		JLabel lblChrisPaul = new JLabel("Chris Paul");
		lblChrisPaul.setHorizontalAlignment(SwingConstants.CENTER);
		lblChrisPaul.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblChrisPaul.setBounds(136, 463, 167, 33);
		contentPane.add(lblChrisPaul);
		
		JLabel lblAndrewWiggins = new JLabel("Andrew Wiggins");
		lblAndrewWiggins.setHorizontalAlignment(SwingConstants.CENTER);
		lblAndrewWiggins.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblAndrewWiggins.setBounds(136, 495, 168, 37);
		contentPane.add(lblAndrewWiggins);
		
		JLabel lblLeBronJames = new JLabel("LeBron James");
		lblLeBronJames.setHorizontalAlignment(SwingConstants.CENTER);
		lblLeBronJames.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblLeBronJames.setBounds(136, 542, 172, 31);
		contentPane.add(lblLeBronJames);
		
		JLabel lblAnthonyDavis = new JLabel("Anthony Davis");
		lblAnthonyDavis.setHorizontalAlignment(SwingConstants.CENTER);
		lblAnthonyDavis.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblAnthonyDavis.setBounds(136, 575, 167, 31);
		contentPane.add(lblAnthonyDavis);
		
		JLabel lblAustinreaves = new JLabel("Austin Reaves");
		lblAustinreaves.setHorizontalAlignment(SwingConstants.CENTER);
		lblAustinreaves.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblAustinreaves.setBounds(136, 611, 167, 33);
		contentPane.add(lblAustinreaves);
		
		JLabel lblDAngeloRoussell = new JLabel("D´Angelo Roussell");
		lblDAngeloRoussell.setHorizontalAlignment(SwingConstants.CENTER);
		lblDAngeloRoussell.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblDAngeloRoussell.setBounds(136, 639, 166, 33);
		contentPane.add(lblDAngeloRoussell);
		
		JLabel lblTaurenPrince = new JLabel("Tauren Prince");
		lblTaurenPrince.setHorizontalAlignment(SwingConstants.CENTER);
		lblTaurenPrince.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblTaurenPrince.setBounds(136, 672, 167, 37);
		contentPane.add(lblTaurenPrince);
		...
		JLabel lblCeltics = new JLabel("Nuggets");
		...
		JLabel lbl76ers = new JLabel("Mavericks");
		...
		JLabel lblHawks = new JLabel("Warriors");
		...
		JLabel lblMagic = new JLabel("Lakers");
